...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( 'start', $tempPath . 'Base/087/', 'Start [01.1.1] (TYPO3 8.7)' );
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( 'start', $tempPath . 'Extensions/ke_search/', 'Start [20.8.1] Facetted search form (ke_sarch)' );
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( 'start', $tempPath . 'Extensions/powermail/', 'Start [20.8.2] powermail optin (Powermail)' );
