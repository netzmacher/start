...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $_EXTKEY, $tempPath . 'Bootstrap/Base/', 'Start [10.1.1] Bootstrap' );
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $_EXTKEY, $tempPath . 'Bootstrap/Fonts/', 'Start [10.1.2] Bootstrap Fonts' );
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $_EXTKEY, $tempPath . 'Extensions/direct_mail/subscribe/', 'Start [20.3.1] Newsletter subscribe (direct_mail)' );
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $_EXTKEY, $tempPath . 'Extensions/indexed_search/', 'Start [20.5.1] Indexed Search' );
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $_EXTKEY, $tempPath . 'Extensions/tx_news/ImageFoundation/', 'Start [20.6.1] txnews images +lightbox (Foundation)' );
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $_EXTKEY, $tempPath . 'Extensions/tt_address/subscribe/', 'Start [XX.X.X] [DEPRECATED!] Use [20.3.1] Subscribe (tt_address) ' );
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $_EXTKEY, $tempPath . 'Extensions/tt_address/unsubscribe/', 'Start [XX.X.X] [DEPRECATED!] Use [20.3.1] Unsubscribe (tt_address)' );
