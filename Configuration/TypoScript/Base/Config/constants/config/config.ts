start {
  ...
  config {
    ...
    # cat=start - config*//110; type=boolean; label= No page title:[Recommended] Do not use the page title that is automatically generated by TYPO3. This enables the using of the page title rendered by the extension Start. Condition: TypoScript te,plates must not contain a website title!
    noPageTitle												= 2
