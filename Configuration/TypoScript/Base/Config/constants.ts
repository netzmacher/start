start {
  ...
  compress {
    ...
    css = 1
    # cat=start - compress css and jss//101; type=boolean; label= JSS:If set, JSS files will compressed. These properties will enabled: config.compressJs, config.concatenateJs.
    jss = 1
  }
