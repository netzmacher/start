start {
  ...
  # cat=start - gridelements//101; type=int+; label= Id 7:Id of the gridelement with accordion or tabs
  gridelement.accordionOrTabs = 7
  # cat=start - gridelements//102; type=int+; label= Id 1:Id of the gridelement with 1 column
  gridelement.col1 = 1
  # cat=start - gridelements//103; type=int+; label= Id 2:Id of the gridelement with 2 columns
  gridelement.col2 = 2
  # cat=start - gridelements//104; type=int+; label= Id 3:Id of the gridelement with 3 columns
  gridelement.col3 = 3
  # cat=start - gridelements//105; type=int+; label= Id 4:Id of the gridelement with 4 columns
  gridelement.col4 = 4
  # cat=start - gridelements//106; type=int+; label= Id 5:Id of the gridelement with 5 columns
  gridelement.col5 = 5
  # cat=start - gridelements//107; type=int+; label= Id 6:Id of the gridelement with 6 columns
  gridelement.col6 = 6
  ...
  pages.contact									=
  # cat=start - pages*//302; type=int+; label=GDPR/DSGVO:Uid of page which contains the General Data Protection Regulation - GDPR (German: Datenschutz-Grundverordnung - DSGVO).
  pages.gdpr										=
  # cat=start - pages*//303; type=int+; label=News:Uid of page which contains your news.
  pages.news										=
  # cat=start - pages*//304; type=int+; label=Newsletter:Uid of page which the form for subscribing the newsletter
  pages.newslettersubscription	=
  # cat=start - pages*//305; type=int+; label=Shop:Uid of page which contains your shop.
  pages.shop										=
  ...
  fluid.path.layouts    = EXT:start/Resources/Private/Templates/foundation-5.5.3/Layouts/
  # cat=start - templates//301; type=string; label= Partials:Path to the fluid partials. With ending slash!
  fluid.path.partials   = EXT:start/Resources/Private/Templates/foundation-5.5.3/Partials/
  # cat=start - templates//302; type=string; label= Templates:Path to the fluid templates. With ending slash!
  fluid.path.templates  = EXT:start/Resources/Private/Templates/foundation-5.5.3/Templates/
