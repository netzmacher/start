// TEST
// vertical menu is running, but an item with class .has-dropdowm must click twice to open the link
  ...
  lib {
    ...
    verticalmenu {
			...
			10 {
				20 = TEXT
				20 {
					value = <nav class="top-bar vertical" data-topbar data-options="custom_back_text:false;is_hover:{$start.foundation.topbar.is_hover};mobile_show_parent_link:{$start.foundation.topbar.mobile_show_parent_link};">
				}
			}
				// Searchform. HMENU: 1, 2, 3, 4, 5, 6. wrap.
			20 = COA
			20 {
				...
				20 {
					...
					1 {
						...
						ACTIFSUB {
							...
							before {
								cObject = TEXT
								cObject {
									dataWrap = <li class="actifsub divider divider-first"></li><li class="active act page-{field:uid} first has-dropdown">| |*| <li class="active act page-{field:uid} has-dropdown">| |*| <li class="active act page-{field:uid} last has-dropdown">|
								}
							}
					...
					2 {
						...
						IFSUB {
							...
							allWrap = <li class="page-{elementUid} has-dropdown first">|</li> |*| <li class="page-{elementUid} has-dropdown">|</li> |*| <li class="page-{elementUid} has-dropdown last">|</li>
							before {
								cObject = TEXT
								cObject {
...
tt_content.menu {
  20 {
    startFoundationVerticalMenu < start.lib.verticalmenu
  }
}