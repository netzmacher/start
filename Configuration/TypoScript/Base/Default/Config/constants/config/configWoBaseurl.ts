start {
  ...
  config {
    ...
    # cat=start - config*//110; type=boolean; label= No page title:[Recommended] Do not use the page title that is automatically generated by TYPO3. This enables the using of the page title rendered by the extension Start. Condition: TypoScript templates must not contain a website title!
    noPageTitle												= 2
    # cat=start - config*//111; type=boolean; label= Page title first:TYPO3 by default prints a HTML title tag in the format "website: page title". If pageTitleFirst is set (and if the page title is printed), then the page title will be printed IN FRONT OF the template title. So it will look like "page title: website". Setup hasn't any effect, if "no page title" is set from above.
    pageTitleFirst                    = 0
