...
start {
	extensions {
		powermail {
			...
			# cat=START - DIRECT_MAIL - POWERMAIL //101;      type=string; label= Direct mail categories: Name of the powermail checkbox for select available newsletters. TAKE ACCOUNT of the category: START - DIRECT_MAIL - CATEGORIES
