start {
  foundation {
    topbar {
      ...
      # cat=start - foundation - topbar*//102;  type=+int;                   label= Crop:Maximum length of a menu item
      crop								= 40
      # cat=start - foundation - topbar*//110;  type=string;                 label= Icon label:The icon label is displayed in minimised menus.
      icon.label.default  = Menu
      # cat=start - foundation - topbar*//111;  type=string;                 label= Icon label (German):The icon label for minimised menus in German language.
      icon.label.de       = Menü
