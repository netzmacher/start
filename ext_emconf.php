...
$EM_CONF[$_EXTKEY] = array(
  ...
  'description' => 'Start TYPO3 Responsive! (start) extends TYPO3 with the responsive framework Foundation (Zurb), '
  ...
  . 'Manual: http://start-typo3-responsive.de/typo3conf/ext/start/doc/manual.pdf. '
  ,
  'category' => 'be',
