...
.. figure:: 01_essentialdata.jpg
	:width: 600px
	:alt: Page properties Start! with sample data

	Page properties Start! with sample data


.. figure:: 01_start_desktop_wi_essentialdata.jpg
	:width: 600px
	:alt: Site with contact data and hyperlinks to social media
