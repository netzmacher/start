...
.. _users_bestpractice_navigation:
...
.. figure:: 01_new_content_element_menu.jpg
	:width: 400px
	:alt: Content wizard with Start menus

	Content wizard with Start menus

.. figure:: 01_start_menu_types.jpg
	:width: 600px
	:alt: Content element with the type [Start: menus]
...
.. figure:: 02_start_menu_topbar.jpg
	:width: 600px
	:alt: Start menu: Top Bar (foundation)
...
.. figure:: 03_topbar_desktop.jpg
	:width: 600px
	:alt: Site with the menu Top Bar (foundation)
