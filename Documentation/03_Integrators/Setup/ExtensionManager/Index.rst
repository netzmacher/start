...
.. _integrators_setup_extensionmanager:
...
You can disable all backend layouts. This is recommended, if you like to use only 
some features of Start and not the whole framework.
