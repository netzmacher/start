CREATE TABLE pages (
  ...
  tx_start_pages_calendar tinyint,
  tx_start_pages_gdpr tinyint,
  tx_start_pages_news tinyint,
  tx_start_pages_newsletter tinyint,
  tx_start_pages_root tinyint,
  tx_start_pages_rss tinyint,
