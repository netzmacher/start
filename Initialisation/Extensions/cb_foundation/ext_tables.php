...
// #i0004, 170227, dwildt, 6+/6-
// #i0003, 170227, dwildt, 6-/6+
...
//\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPlugin(array('Orbit Slider', 'cbfoundation_orbit',
//		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY) . 'Resources/Public/Icons/orbit_ct.gif'), 'CType');
//\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPlugin(array('Clearing Lightbox', 'cbfoundation_clearing',
//		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY) . 'Resources/Public/Icons/clearing_ct.gif'), 'CType');
//\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPlugin(array('Flexible Video', 'cbfoundation_flexvid',
//		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY) . 'Resources/Public/Icons/flexvid_ct.gif'), 'CType');
